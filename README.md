  ...
  <main class="container" id="top">
    ...
    <section id="download" class="download" style="margin-top:40px" aria-labelledby="download-title">
      ...
      <p style="margin-top:18px">
        <a id="real-download" href="https://example.com/download/NovaCleanerPro.zip" class="btn btn-primary" download aria-label="Скачать NovaCleaner (ZIP)">⬇ Скачать NovaCleaner (ZIP)</a>
      </p>
